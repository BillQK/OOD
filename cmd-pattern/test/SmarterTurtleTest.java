...
/**
 * Test class for the SmarterTurtle model.
 */
public final class SmarterTurtleTest {
  ...
  public void testTrace() {
    ...
    assertEquals(0.0, lines.get(0).getStart().getX(), 0.001);
    assertEquals(0.0, lines.get(0).getStart().getY(), 0.001);
    assertEquals(10.0, lines.get(0).getEnd().getX(), 0.001);
    assertEquals(0.0, lines.get(0).getEnd().getY(), 0.001);
  }
